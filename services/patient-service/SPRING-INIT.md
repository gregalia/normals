<!-- automatically generated by `spring init` -->
...
```sh
docker run --rm --expose=8080:8080 patient-service:0.0.1-SNAPSHOT
```
...
```sh
build/native/nativeCompile/patient-service
```
...
about
[toolchain support in the Native Build Tools here](https://graalvm.github.io/native-build-tools/latest/gradle-plugin.html#configuration-toolchains).
